    ...
    var t = {
        ...
        352: function(t, e, r) {
            ...
            t.exports = function(t, e, h) {
                var d, v = this, g = r(423)(v), m = r(302)(v), p = r(664)(v);
                d = {
                    start: function() {
                        v.listClass = "list",
                        ...
                        v.filter = r(448)(v),
                        v.sort = r(745)(v),
                        v.fuzzySearch = r(277)(v, e.fuzzySearch),
                        this.handlers(),
                        this.items(),
                        this.pagination(),
                        v.update())
                ...
                var e = !1
                  , r = function(r, i) {
                    ...
                    for (var g = 1; g <= c; g++) {
                        ...
                        s.elm.firstChild.setAttribute("data-page", u)) : a.dotted(r, g, d, v, f, h, r.size()) && (s = r.add({
                            page: "...",
                            dotted: !0
                        })[0],
            ...
            t.exports = function(t, e, r) {
                ...
                for (var v, g = e.length + t.length, m = 0; m < e.length; m++) {
                    ...
                    for (var b = C; b >= p; b--) {
                        ...
                        if (y[b] = 0 === m ? (y[b + 1] << 1 | 1) & x : (y[b + 1] << 1 | 1) & x | (v[b + 1] | v[b]) << 1 | 1 | v[b + 1],
                        y[b] & d) {
                            var w = l(m, b - 1);
                            if (w <= u) {
                                if (u = w,
            ...
            function s(t, e) {
                for (var s = (t += "").length, a = (e += "").length, o = 0, l = 0; o < s && l < a; ) {
                    ...
                    if (i(u)) {
                        if (!i(c))
                            return u - c;
                        for (var f = o, h = l; 48 === u && ++f < s; )
                            u = t.charCodeAt(f);
                        for (; 48 === c && ++h < a; )
                            c = e.charCodeAt(h);
                        for (var d = f, v = h; d < s && i(t.charCodeAt(d)); )
                            ++d;
